  ...
  return (
    <Container>
        <Section
          ...
          description="6 mois pour devenir un développeur Fullstack JavaScript et acquière l’expertise d’un développeur moderne web, mobile et jeux vidéos en 2022"
